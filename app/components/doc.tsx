 ...
 return (
  <div className='p-8 max-w-xl  flex-col gap-4 hidden'>
   <div className='bg-slate-200 flex flex-col gap-2'>
    ...
    <div className='flex flex-col'>
     ...
     <div className='flex gap-2 '>
      <p className=''>{data.contact.firstName}</p>
      <p>{data.contact.lastName}</p>
     </div>
    </div>
    <div className='flex gap-2'>
     <div className='flex flex-col'>
    ...
    <div className='flex flex-col'>
     ...
     <p>{data.contact.state}</p>
    </div>
    <div className='flex flex-col'>
     <p className='text-sm'>Zip:</p>
     <p>{data.contact.zip}</p>
    </div>
    <div className='flex flex-col'>
   ...
   <div className='bg-slate-200'>
    ...
    <p>{data.employed ? 'Yes' : 'No'}</p>
    <div>
     {data.employed && (
      <div className='mt-2 flex flex-col gap-2'>
       <div>
        <p className='text-sm'>Employer:</p>
        <p>{data.currentEmployment.location}</p>
       </div>
       <div>
        <p className='text-sm'>Duration:</p>
        <p>{data.currentEmployment.duration}</p>
       </div>
      </div>
     )}
    </div>
     ...
     {data.prevEmploy.map((employment, index) => (
      <div key={employment.id}>
       <div>
        ...
        <p>{employment.employer ? employment.employer : 'N/A'}</p>
       </div>
       {employment.employer && (
        <div className='flex flex-col'>
         <div>
